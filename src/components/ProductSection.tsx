            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-lg text-zinc-600 leading-relaxed font-light">{description}</p>
                        ...
                        {expertVerdict && (
                            <div className="bg-ea-green-900/10 border border-ea-green-500/30 p-6 rounded-xl relative overflow-hidden group">
                                ...
                                <p className="text-sm font-bold text-zinc-700 italic leading-relaxed">&quot;{expertVerdict}&quot;</p>
                            </div>
                        )}

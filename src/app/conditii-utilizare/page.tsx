        ...
        <main className="min-h-screen bg-white text-zinc-600 py-32 px-6">
            <div className="max-w-4xl mx-auto space-y-12">
                <div className="space-y-4">
                    <Link href="/" className="text-ea-green-600 hover:text-ea-green-700 transition-colors inline-flex items-center gap-2 mb-4">
                        ← Înapoi la Pagina Principală
                    </Link>
                    <h1 className="text-4xl md:text-5xl font-black text-zinc-900 uppercase tracking-tighter">Condiții de Utilizare</h1>
                    <p className="text-zinc-600 text-sm">Ultima actualizare: 23 Februarie 2026</p>
                </div>

                <section className="space-y-6">
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">1. Acceptarea Termenilor</h2>
                        <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">2. Proprietate Intelectuală</h2>
                        <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">3. Utilizarea Calculatorului ROI</h2>
                        <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">4. Limitarea Răspunderii</h2>
                        <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">5. Legislația Aplicabilă</h2>
                        <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-zinc-900 uppercase tracking-tight">6. Contact</h2>
                        <p>
                            Pentru întrebări legate de acești termeni, ne puteți contacta la: <br />
                            <span className="text-zinc-900 font-bold">Email: tehnicagro.supply@gmail.com</span> <br />
                            <span className="text-zinc-900 font-bold">Telefon: 0723 380 022</span>
                        </p>
                    </div>
                </section>
            </div>

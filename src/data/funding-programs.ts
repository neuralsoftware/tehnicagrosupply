...
export const FUNDING_PROGRAMS: Record<string, FundingProgram[]> = {
    ...
    'pregatire-sol': [
        ...
        },
        {
            ...
            notes: 'Ghid finalizat, a trecut de consultarea publică — lansare confirmată pentru 15 Sep 2026 (dată amânată din cauza situației de la Cadastru și perioadei de concedii din august)'
        }
    ],
    ...
    'semanat-fertilizat': [
        ...
        },
        {
            ...
            notes: 'Ghid finalizat, a trecut de consultarea publică — lansare confirmată pentru 15 Sep 2026'
        }
    ],
